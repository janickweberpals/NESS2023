...
Hotelling's[@hotelling1931] multivariate t-test examines differences in covariate distributions conditional on having an observed covariate value or not. Rejection of $H0$ would indicate significant differences between these patients strata.
...
-   ::: {style="color: red"}
    Presentation `quarto` code: <https://github.com/janickweberpals/NESS2023> (accessible after SciComms/FDA approval)
    :::

-   ::: {style="color: red"}
    Presentation slides: <https://janickweberpals.github.io/NESS2023> (accessible after SciComms/FDA approval)
    :::
